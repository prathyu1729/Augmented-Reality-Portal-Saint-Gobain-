...
namespace GoogleARCore.Examples.Common
{
    ...
    /// </summary>
    public class VisualiserGrid : MonoBehaviour
    {
        ...
        {
            m_DetectedPlane.GetBoundaryPolygon(m_MeshVertices);//Gets a list of points (in clockwise order) in Unity world space representing a boundary polygon for the plane.
            ...
            m_PreviousFrameMeshVertices.AddRange(m_MeshVertices);//appends items to the end of the list
